      ...
      <div class="right_col" role="main">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <h2>Tabel Matrik Perhitungan SAW
                <a href="" class="btn btn-dark btn-xs pull-right" data-toggle="modal" data-target="#ModalTambahUser"> <i class="fa fa-plus-square"></i> Tampil Rangking</a>
              </h2>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <?php foreach ($ma as $m) : ?>
                              ...
                              <td><?= $m['k7']; ?></td>
                              <td>
                                <a href="<?= base_url('na/hapusMa/') . $m['kd_ma']; ?>" class="tombol-hapus btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i> Hapus</a>
                              </td>
                          </tr>
                          <?php $no++; ?>
                        <?php endforeach ?>
